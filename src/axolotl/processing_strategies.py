...
class Glm4vProcessingStrategy(ProcessingStrategy):
    ...
    def __init__(
        ...
        self.image_token = "<|image|>"  # nosec B105
        self.begin_image_token = "<|begin_of_image|>"  # nosec B105
        self.end_image_token = "<|end_of_image|>"  # nosec B105
        self.video_token = "<|video|>"  # nosec B105
        self.begin_video_token = "<|begin_of_video|>"  # nosec B105
        self.end_video_token = "<|end_of_video|>"  # nosec B105
