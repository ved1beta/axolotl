...
```yaml
base_model: Qwen/Qwen3.5-7B  # smallest VLM variant
...
See [examples/qwen3.5/7b-fft-vision.yaml](https://github.com/axolotl-ai/axolotl/blob/main/examples/qwen3.5/7b-fft-vision.yaml).
